...
public class CommentController {
  ...
  public ResponseWrapper<Comment> doOperation(HttpServletRequest request) {
    try {
      ...
      final RequestWrapper<Comment> requestWrapper = objectMapper
          .readValue(payload, new TypeReference<RequestWrapper<Comment>>() {
          });
      ...
      return ResponseWrapper
          .error(String.format("Unknown command %s", requestWrapper.getCommand()));
