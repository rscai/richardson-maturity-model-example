package io.github.rscai.rmm.level2;
...
public class L2CommentControllerTest {
  ...
  public void testCreate() throws Exception {
    ...
    mockMvc.perform(post(url, postId).
        ...
        .andExpect(jsonPath("$.post.id", is((int) postId)))
  ...
  public void testUpdate() throws Exception {
    ...
    mockMvc.perform(
        put(url + "/{commentId}", existedPostId, existedId).contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON)
            .content(objectMapper.writeValueAsString(existedOne))).andExpect(status().isOk())
        .andExpect(jsonPath("$.content", is("Updated content"))).andDo(
        document("level2/comment/update",
  ...
  public void testDelete() throws Exception {
    ...
    mockMvc.perform(delete(url + "/{commentId}", existedPostId, existedCommentId)
        .contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk()).andDo(document("level2/comment/delete",
        pathParameters(parameterWithName("postId").description("Post's id"),
            parameterWithName("commentId").description("comment's id"))));
    mockMvc.perform(get(url + "/{commentId}", existedPostId, existedCommentId)
        .contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
  ...
  public void testGetOne() throws Exception {
    ...
    mockMvc.perform(get(url + "/{commentId}", existedPostId, existedCommentId)
        .contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk()).andDo(document("level2/comment/get",
        pathParameters(parameterWithName("postId").description("Post's id"),
            parameterWithName("commentId").description("comment's id"))));
  }
  ...
  public void testGetAll() throws Exception {
    ...
    mockMvc.perform(
        get(url, existedPostId).contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk()).andExpect(jsonPath("$", hasSize(5))).andDo(
        document("level2/comment/getAll",
            pathParameters(parameterWithName("postId").description("post's id"))));
  }
  ...
  private long insertOneComment(final long postId) throws Exception {
    ...
    newOne.setPost(post);
    final Comment insertedOne = objectMapper.readValue(mockMvc.perform(
        post(url, postId).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
            .content(objectMapper.writeValueAsString(newOne))).andExpect(status().isCreated())
        .andReturn().getResponse().getContentAsString(), Comment.class);
  ...
  private Comment getOneComment(final long postId, final long commentId) throws Exception {
    return objectMapper.readValue(mockMvc.perform(
        get(url + "/{commentId}", postId, commentId).contentType(MediaType.APPLICATION_JSON)
  ...
  private Post getOnePost(final long id) throws Exception {
    return objectMapper.readValue(
        mockMvc.perform(get("/api/level2/post/{id}", id).contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON))
  ...
  private long insertOnePost() throws Exception {
    ...
    final Post existedOne = objectMapper.readValue(mockMvc.perform(
        post("/api/level2/post").contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON)
            .content(objectMapper.writeValueAsString(one))).andExpect(status().isCreated())
        .andReturn().getResponse().getContentAsString(), Post.class);
