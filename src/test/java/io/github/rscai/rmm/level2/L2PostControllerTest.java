...
public class L2PostControllerTest {
  ...
  public void testCreate() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andExpect(jsonPath("$.content", is("New Post content")))
        .andExpect(jsonPath("$.createdAt", notNullValue()))
        .andDo(document("level2/post/create"));
  }
  ...
  public void testUpdate() throws Exception {
    ...
    mockMvc.perform(put(url + "/{id}", existedId).contentType(MediaType.APPLICATION_JSON)
        ...
        .andDo(document("level2/post/update",
  ...
  public void testGet() throws Exception {
    ...
    mockMvc.perform(get(url + "/{id}", existedId).contentType(MediaType.APPLICATION_JSON)
        ...
        .andExpect(jsonPath("$.createdAt", notNullValue())).andDo(document("level2/post/get",
        pathParameters(parameterWithName("id").description("post's id"))));
  }
  ...
  public void testGetAll() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andDo(document("level2/post/getAll"));
  }

  private Post getOne(final long id) throws Exception {
    return objectMapper.readValue(
        mockMvc.perform(get(url + "/{id}", id).contentType(MediaType.APPLICATION_JSON)
